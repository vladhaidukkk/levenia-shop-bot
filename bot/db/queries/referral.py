...
@inject_session
async def add_referral(session: AsyncSession, user_tg_id: int, referrer_tg_id: id) -> ReferralModel:
    try:
        new_referral = ReferralModel(user_tg_id=user_tg_id, referrer_tg_id=referrer_tg_id)
